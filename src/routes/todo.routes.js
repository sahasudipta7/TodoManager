...
import { createTodo,getTodo,toggleTodoComplete,renameTodo,deleteTodo } from "../contollers/todo.controllers.js";
...
router.route("/renameTodo").post(verifyJWT,renameTodo)
